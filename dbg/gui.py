...
class New_Toplevel_1:
    def __init__(self, master=None):
        ...
        self.TLabelframe10.place(relx=0.04, rely=0.53, relheight=0.26
                , relwidth=0.38)
