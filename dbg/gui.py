...
class New_Toplevel_1:
    def __init__(self, master=None):
        ...
        self.TLabelframe2.place(relx=0.04, rely=0.06, relheight=0.25
                , relwidth=0.68)
        ...
        self.TLabelframe3.place(relx=0.04, rely=0.34, relheight=0.25
                , relwidth=0.68)
        ...
        self.TLabelframe4.place(relx=0.05, rely=0.06, relheight=0.19
                , relwidth=0.53)
        self.TLabelframe4.configure(text='''Tasto''')
        self.TLabelframe4.configure(width=300)

        self.Button11 = Button(self.TLabelframe4)
        self.Button11.place(relx=0.1, rely=0.33, height=34, width=62)
        ...
        self.Button11.configure(width=62)

        self.Button12 = Button(self.TLabelframe4)
        self.Button12.place(relx=0.68, rely=0.39, height=29, width=62)
        ...
        self.Button12.configure(width=62)

        self.Entry7 = Entry(self.TLabelframe4)
        self.Entry7.place(relx=0.37, rely=0.39, relheight=0.28, relwidth=0.26)
        ...
        self.Entry7.configure(width=79)
